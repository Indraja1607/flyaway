...
<%@ page import = "com.ESources" %>
<%@ page import = "com.EDestinations" %>
<%@ page import = "com.EAirLines" %>
<%@ page import = "com.EPassenger" %>
<%@ page import = "com.BookingInformation" %>
<%@ page import = "java.util.*" %>

<jsp:useBean id= "hibernateUtil" class="com.HibernateUtil"/>
<!DOCTYPE html>
<html>
<head>
